...
void Renderer::Render(Snake const snake, SDL_Point const &food, SDL_Point const &obstacle, bool change_level) {
  SDL_Rect block;
  
  if (_change_theme == false){
  ...
  // Render Obstacle
  if (change_level){
    SDL_SetRenderDrawColor(sdl_renderer, 165, 42, 42, 0xFF);
